...
class PenjualanDetailController extends Controller
{
    ...
    public function data($id)
    {
        ...
        foreach ($detail as $item) {
            ...
            $row['harga_jual']  = 'UGX '. format_uang($item->harga_jual);
    ...
    public function lookupByBarcode($kode)
    {
        ...
        return response()->json([
            ...
            'harga_jual_fmt' => 'UGX ' . format_uang($produk->harga_jual),
            'stok'         => $produk->stok,
    ...
    public function loadForm($diskon = 0, $total = 0, $diterima = 0)
    {
        ...
        $data    = [
            ...
            'terbilang' => ucwords(terbilang($bayar). ' UGX'),
            'kembalirp' => format_uang($kembali),
            'kembali_terbilang' => ucwords(terbilang($kembali). ' UGX'),
        ];
