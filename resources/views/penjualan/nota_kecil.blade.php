...
<body onload="window.print()">
    ...
    <div class="text-center" style="margin-top: 25px; padding: 10px; border: 1px dashed #ccc; border-radius: 5px;">
        <p style="font-size: 8pt; margin-bottom: 8px; font-weight: bold;">Scan to verify purchase</p>
        @php
            $qrCodePath = $penjualan->generateQRCode();
            echo '<div style="display: inline-block; padding: 8px; background: white; border: 1px solid #555; border-radius: 4px;"><img src="' . asset($qrCodePath) . '" alt="QR Code" style="width: 80px; height: 80px; display: block;"></div>';
        @endphp
        <p style="font-size: 6pt; margin-top: 5px; color: #666;">Receipt #{{ tambah_nol_didepan($penjualan->id_penjualan, 10) }}</p>
    </div>
