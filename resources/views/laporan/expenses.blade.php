...
@section('title')
Expenses Report {{ tanggal_indonesia($tanggalAwal, false) }} &mdash; {{ tanggal_indonesia($tanggalAkhir, false) }}
@endsection
    ...
    <div class="col-lg-12">
        <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-money"></i> Expenses Report</h3>
                <div class="box-tools pull-right">
                    <button onclick="updatePeriode()" class="btn btn-primary btn-flat btn-sm">
                        <i class="fa fa-calendar"></i> Change Date Range
                    </button>
                    <a href="{{ route('laporan.expenses_pdf', [$tanggalAwal, $tanggalAkhir]) }}" target="_blank" class="btn btn-danger btn-flat btn-sm">
            ...
            <div class="box-body table-responsive no-padding">
                <table class="table table-striped table-bordered table-hover table-expenses">
                    <thead>
                        <th width="5%">#</th>
                        <th>Date</th>
                        <th>Description</th>
...
<div class="modal fade" id="modal-form" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <form action="{{ route('laporan.expenses') }}" method="get" class="form-horizontal">
...
<script>
    $(function () {
        $('.table-expenses').DataTable({
            ...
            buttons: [
                { extend: 'csvHtml5',   text: '<i class="fa fa-file-text-o"></i> CSV',   className: 'btn btn-sm btn-default btn-flat', title: 'Expenses Report' },
                { extend: 'excelHtml5', text: '<i class="fa fa-file-excel-o"></i> Excel', className: 'btn btn-sm btn-success btn-flat', title: 'Expenses Report' },
                { extend: 'print',      text: '<i class="fa fa-print"></i> Print',       className: 'btn btn-sm btn-info btn-flat',    title: 'Expenses Report' },
            ],
            ajax: { url: '{{ route('laporan.expenses_data', [$tanggalAwal, $tanggalAkhir]) }}' },
            columns: [
